...
<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="index.php?halaman=hapusproduk&id=<?php echo $pecah['id_kopi']; ?>" class="btn-danger btn">hapus</a>
...
<a href="index.php?halaman=tambahpesanan" class="btn btn-primary">Tambah Pesanan</a>